...
RxTest:
	...
	rvbrflagtrue SatFrameValid, rxt1;display a "NO SIGNAL" message if Satelite signal is absent
...
rxt1:	call GetRxChannels
	...
	rvbrflagfalse SatFrameValid, rxt8	;update the display also when RX data has become invalid
...
RxTest2:
	...
	rvbrflagfalse SatFrameValid, rxt204	;update the display also when RX data has become invalid

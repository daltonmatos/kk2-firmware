...
extern const char _log_error_title;


void _log_error_ok_callback(uint8_t selected_item){
}

void _log_error_render(uint8_t selected_item){

}

void error_log(){
  ScreenData->title = &_log_error_title;
  ScreenData->footer = 0;
  ScreenData->footer_callback = &print_std_footer;
  ScreenData->options = 0;
  ScreenData->initial_option = 0;
  ScreenData->ok_callback = &_log_error_ok_callback;
  ScreenData->render_callback = &_log_error_render;
  ScreenData->total_options = 1;
}
